...
class Atulya_Control_Panel {
	...
	public static function render() {
		...
		<div class="wrap">
			...
			<p style="max-width:760px;">Yahan se website ki settings badlo — koi coding nahi. Save karte hi website (frontend) ~1 minute me apne aap update ho jayegi.</p>
			...
			<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>">
				...
				<table class="form-table" role="presentation">
					<tr>
						...
						<p class="description">Har order pe delivery charge (₹99).</p></td>
					</tr>
					<tr>
						...
						<p class="description">Is amount ya usse zyada ke order pe delivery FREE. (0 = kabhi free nahi.)</p></td>
					</tr>
				</table>
				...
				<table class="form-table" role="presentation">
					<tr>
						...
						<td><label><input type="checkbox" name="gst_enabled" value="1" <?php echo $chk( 'gst_enabled' ); ?> /> Checkout pe GST add karo</label></td>
					</tr>
					<tr>
				...
				<table class="form-table" role="presentation">
					<tr>
						...
						<td><label><input type="checkbox" name="announcement_enabled" value="1" <?php echo $chk( 'announcement_enabled' ); ?> /> Top announcement bar dikhao</label></td>
					</tr>
					<tr>
						...
						<p class="description">Khali chhodoge to default message chalega.</p></td>
					</tr>
				</table>
				...
				<table class="form-table" role="presentation">
					<tr>
						...
						<td><label><input type="checkbox" name="whatsapp_enabled" value="1" <?php echo $chk( 'whatsapp_enabled' ); ?> /> Floating WhatsApp button dikhao</label></td>
					</tr>
					<tr>
						...
						<p class="description">Country code ke saath, bina + ya space (jaise 918851180015).</p></td>
					</tr>
					<tr>
				...
				<table class="form-table" role="presentation">
					<tr>
						...
						<td><label><input type="checkbox" name="cod_enabled" value="1" <?php echo $chk( 'cod_enabled' ); ?> /> Checkout pe Cash on Delivery option dikhao</label>
						<p class="description">(COD ka checkout flow next phase me wire hoga — abhi ye sirf setting hai.)</p></td>
					</tr>
				</table>
				...
				<table class="form-table" role="presentation">
					<tr>
						...
						<td><label><input type="checkbox" name="popup_enabled" value="1" <?php echo $chk( 'popup_enabled' ); ?> /> Naye visitor ko ek baar discount popup dikhao</label></td>
					</tr>
					<tr>
				...
				<p style="max-width:820px;">Har offer ke liye: <b>Match</b> me products ke <b>slug</b> ya <b>keyword</b> daalो (comma se alag — jaise <code>face wash, atulya-cucumber-toner</code>). <b>Buy</b> = kitne ke paise, <b>Free</b> = kitne free. Example: Buy 1, Free 2 = "1 ke paise, 3 milenge". Khali rows ignore ho jayengi.</p>
